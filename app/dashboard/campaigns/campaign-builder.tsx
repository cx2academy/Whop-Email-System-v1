...
export function CampaignBuilder({
  tags, segments = [], fromName = 'Your Name', fromEmail = 'you@example.com', brandColor = '#22C55E',
      ...
      <div className="flex flex-1 overflow-hidden min-h-0">
        ...
        <div className="flex flex-col flex-[3] overflow-hidden min-w-0"
          ...
          <div className="flex-1 overflow-hidden">
            {editorMode === 'visual' ? (
              <VisualEditor value={htmlBody} onChange={setHtmlBody} brandColor={brandColor} subject={subject} />
            ) : (
