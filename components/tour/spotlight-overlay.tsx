...
export function SpotlightOverlay() {
  ...
  useEffect(() => {
    ...
    if (activeStep.actionType === 'click' || activeStep.actionType === 'navigate' || activeStep.actionType === 'async-click') {
        ...
        if (e.clientX >= sx && e.clientX <= sx + sw && e.clientY >= sy && e.clientY <= sy + sh) {
          ...
          if (targetElement) {
              if (targetElement.contains(e.target as Node)) {
                  if (activeStep.actionType !== 'async-click') nextStep();
              } else {
  ...
  const isInteractiveHole = activeStep.actionType === 'click' || activeStep.actionType === 'navigate' || activeStep.actionType === 'async-click';
  ...
  return (
    <div className="fixed inset-0 z-[999999] pointer-events-none">
      ...
      >
        ...
        {(activeStep.actionType === 'click' || activeStep.actionType === 'navigate' || activeStep.actionType === 'async-click') && (
