...
export function ContinuousBento() {
  return (
    <section className="w-full bg-[#FAFAFA] flex flex-col items-center pt-16 md:pt-24 overflow-hidden relative border-t border-zinc-200">
      {/* Background Pattern */}
      <div 
      ...
      <div className="relative w-full max-w-[1280px] border-x border-zinc-200 z-10 flex flex-col">
          {/* Header */}
          <div className="px-4 md:px-12 pt-12 md:pt-16 pb-12 md:pb-20 border-b border-zinc-200 relative bg-white/70 backdrop-blur-md">
            <div className="flex items-center gap-3 mb-4 md:mb-6">
               <div className="h-px w-4 md:w-6 bg-zinc-300"></div>
               <span className="text-zinc-500 font-mono text-[10px] md:text-xs uppercase tracking-widest font-semibold">[01] Powerful Platform</span>
            </div>
            <h2 className="text-3xl md:text-5xl lg:text-[56px] font-medium text-zinc-900 tracking-tight max-w-4xl text-balance">
          ...
          <div className="flex flex-col lg:flex-row w-full border-b border-zinc-200 relative bg-white">
            ...
            <div className="lg:w-1/3 flex flex-col p-6 lg:p-12 relative z-10">
              <h3 className="text-xl md:text-2xl font-medium text-zinc-900 mb-2 md:mb-3 tracking-tight">Automate everything</h3>
              <p className="text-zinc-500 text-sm md:text-base leading-relaxed text-balance">
            ...
            <div className="lg:w-2/3 p-4 md:p-8 bg-[#FAFAFA] relative overflow-hidden flex items-center justify-center min-h-[300px] md:min-h-[500px] border-t lg:border-t-0 border-zinc-200 lg:border-l-0">
               <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.02)_0%,transparent_70%)]" />
               <div className="relative w-full max-w-[600px] scale-75 sm:scale-100">
                  <WorkflowGraphic />
               </div>
            </div>
          </div>
          ...
          <div className="flex flex-col lg:flex-row w-full border-b border-zinc-200 relative bg-white z-0">
            ...
            <div className="lg:w-2/3 p-4 md:p-12 relative overflow-hidden flex items-center justify-center min-h-[250px] md:min-h-[400px] order-2 lg:order-1 bg-[#FAFAFA] border-t lg:border-t-0 border-zinc-200">
               <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.02)_0%,transparent_70%)]" />
               <div className="relative w-full max-w-xl scale-[0.6] sm:scale-100 z-10 h-[340px]">
                 <SyncDemo />
               </div>
            </div>

            <div className="lg:w-1/3 flex flex-col p-6 lg:p-12 relative z-10 order-1 lg:order-2">
              <h3 className="text-xl md:text-2xl font-medium text-zinc-900 mb-2 md:mb-3 tracking-tight">Direct Integration</h3>
              <p className="text-zinc-500 text-sm md:text-base leading-relaxed text-balance">
          ...
          <div className="flex flex-col lg:flex-row w-full border-b border-zinc-200 relative bg-white">
            ...
            <div className="lg:w-1/3 flex flex-col p-6 lg:p-12 relative z-10">
              <h3 className="text-xl md:text-2xl font-medium text-zinc-900 mb-2 md:mb-3 tracking-tight">Powerful reporting</h3>
              <p className="text-zinc-500 text-sm md:text-base leading-relaxed text-balance">
            ...
            <div className="lg:w-2/3 p-4 md:p-8 bg-[#FAFAFA] relative overflow-hidden flex items-center justify-center min-h-[300px] md:min-h-[500px] border-t lg:border-t-0 border-zinc-200 lg:border-l-0">
               <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.02)_0%,transparent_70%)]" />
               <div className="scale-75 md:scale-100 w-full max-w-[420px] flex items-center justify-center z-10">
                  <MetricSwitcher />
               </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-full relative bg-white border-b border-zinc-200">
            ...
            <div className="w-full flex justify-center p-6 lg:p-12 lg:pb-16 text-center border-b border-zinc-200 bg-white z-10 relative">
              <div className="max-w-3xl flex flex-col items-center">
                <h3 className="text-xl md:text-3xl font-medium text-zinc-900 mb-2 md:mb-4 tracking-tight">Deploy AI Agents</h3>
                <p className="text-zinc-500 text-sm md:text-base leading-relaxed text-balance max-w-2xl md:text-lg">
            ...
            <div className="w-full relative flex items-center justify-center bg-[#FAFAFA] min-h-[400px] md:min-h-[500px] overflow-hidden">
               <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,0,0,0.02)_0%,transparent_70%)]" />
               <div className="absolute inset-0 w-full h-full z-10 flex items-center justify-center">
                 <div className="relative w-full h-full scale-[0.6] sm:scale-[0.8] md:scale-100 origin-center flex items-center justify-center">
                   <AgentSwarm />
                 </div>
               </div>
            </div>
